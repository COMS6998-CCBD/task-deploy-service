...
tds_logger.setLevel(logging.INFO if not os.environ.get('DEBUG') else logging.DEBUG)
...
if os.path.isdir('logs'):
    ...
    tds_logger.addHandler(file_handler)

tds_logger.addHandler(console_handler)